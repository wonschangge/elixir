...
blacklist_ts = (
    ...
    b'BroadcastChannel'
    b'Buffer'
    b'ByteLengthQueuingStrategy'
    b'CompressionStream'
    b'CountQueuingStrategy'
    b'Crypto'
    b'CryptoKey'
    b'CustomEvent'
    b'DOMException'
    ...
    b'Proxy'
    b'RangeError'
    b'ReadableByteStreamController'
    b'ReadableStream'
    b'ReadableStreamBYOBReader'
    b'ReadableStreamBYOBRequest'
    b'ReadableStreamDefaultController'
    b'ReadableStreamDefaultReader'
    b'ReferenceError'
    b'Reflect'
    b'RegExp'
    b'Request'
    ...
    b'TextEncoderStream'
    b'TransformStream'
    b'TransformStreamDefaultController'
    b'TypeError'
    b'URIError'
    b'URL'
    b'URLSearchParams'
    ...
    b'WebAssembly'
    b'WritableStream'
    b'WritableStreamDefaultController'
    b'WritableStreamDefaultWriter'
    b'abstract'
    b'any'
    b'as'
    b'assert'
